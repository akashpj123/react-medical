    ...
    return (
        <div className="card">
            <div className="card-body">
                ...
                <Link to={`/blog/posts/${props.post.id}/edit`} className="btn btn-warning float-right ml-1">Edit</Link>
                <Link to={`/blog/posts/${props.post.id}`} className="btn btn-info float-right ml-1">View</Link>
